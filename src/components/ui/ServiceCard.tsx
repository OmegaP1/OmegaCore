...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, index }) => {
  ...
  return (
    <motion.div
      ...
      whileHover="hover"
      className="glass-card p-8 rounded-xl flex flex-col items-center text-center relative overflow-hidden group"
    >
      {/* Top gradient border */}
      ...
      >
        <a
          href="#contact"
          className="text-accent hover:text-white transition-colors duration-300 flex items-center gap-1"
        >
