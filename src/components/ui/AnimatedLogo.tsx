...
const AnimatedLogo: React.FC = () => {
  return (
    <div
      ...
      aria-label="OmegaCore animated logo"
      role="img"
    >
      ...
      <div
        className="absolute w-[10%] h-[10%] bg-accent rounded-full top-[0] left-1/2 -translate-x-1/2"
        aria-hidden="true"
      >
      ...
      <div
        className="absolute w-[10%] h-[10%] bg-accent rounded-full bottom-[0] left-1/2 -translate-x-1/2"
        aria-hidden="true"
      >
      ...
      <div
        className="absolute w-full h-full rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-radial-pulse opacity-0 animate-pulse"
        aria-hidden="true"
      ></div>
    </div>
  );
